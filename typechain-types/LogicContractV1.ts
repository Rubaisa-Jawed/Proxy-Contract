...
export interface LogicContractV1Interface extends utils.Interface {
  functions: {
  ...
  events: {
    "Add(uint256,uint256)": EventFragment;
  };
...
export interface LogicContractV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LogicContractV1Interface;
  ...
  filters: {
    "Add(uint256,uint256)"(a?: null, b?: null): AddEventFilter;
    Add(a?: null, b?: null): AddEventFilter;
  };
